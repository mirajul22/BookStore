...
const Navbar = () => {
  ...
  const navItems = (
   ...
   <li>
            <NavLink
              to="/"
              className={({ isActive }) => (isActive ? "bg-pink-500 text-white" : "")}
            >
              Home
            </NavLink>
          </li>
  ...
  return (
    <>
    <div  className={`w-full ${sticky ? 'sticky top-0 left-0 z-50 shadow-md bg-white dark:bg-slate-900 transition-all duration-500 ease-in-out' : 'relative'} `}>
        ...
        <div className='navbar'>
          ...
          <div className='navbar-end space-x-3'>
            ...
            <div className='hidden md:block'>
              <label className='px-4 py-2 border flex items-center gap-2'>
                <input
                  type='text'
